                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <form action="{{ route('jenistinggal.index') }}" method="get">
                                ...
                                <div class="col-2">
                                    {!! button('jenistinggal.create', $title) !!}  
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! button('jenistinggal.show','', $item->id) !!}
                                                    {!! button('jenistinggal.edit', $title, $item->id) !!}
                                                    {!! button('jenistinggal.destroy', $title, $item->id) !!}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
