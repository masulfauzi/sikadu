...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('siswa', function (Blueprint $table) {
            ...
            $table->foreign('sekolah_asal')->references('id')->on('sekolah_asal')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->foreign('alat_transportasi')->references('id')->on('alat_transportasi')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('jenis_tinggal')->references('id')->on('jenis_tinggal')->onUpdate('cascade')->onDelete('cascade');
