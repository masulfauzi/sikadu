...
class DesaController extends Controller
{
	...
	{
		$ref_kecamatan = Kecamatan::all()->pluck('created_by','id');
		
		$data['forms'] = array(
			'id_kecamatan' => ['Kecamatan', html()->select("id_kecamatan", $ref_kecamatan, null)->class("form-control")->class("select2") ],
			'nama_desa' => ['Nama Desa', html()->text("nama_desa", old("nama_desa"))->class("form-control") ],
	...
	public function edit(Request $request, Desa $desa)
	{
		...
		$data['forms'] = array(
			'id_kecamatan' => ['Kecamatan', html()->select("id_kecamatan", $ref_kecamatan, null)->class("form-control")->class("select2") ],
			'nama_desa' => ['Nama Desa', html()->text("nama_desa", $desa->nama_desa)->class("form-control") ],
