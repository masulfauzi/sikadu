                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <form action="{{ route('alattransportasi.index') }}" method="get">
                                ...
                                <div class="col-2">
                                    {!! button('alattransportasi.create', $title) !!}  
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! button('alattransportasi.show','', $item->id) !!}
                                                    {!! button('alattransportasi.edit', $title, $item->id) !!}
                                                    {!! button('alattransportasi.destroy', $title, $item->id) !!}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
