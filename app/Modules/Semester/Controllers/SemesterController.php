...
class SemesterController extends Controller
{
	...
	public function create(Request $request)
	{
		...
		$data['forms'] = array(
			'semester' => ['Semester', html()->text("semester", old("semester"))->class("form-control") ],
			'urutan' => ['Urutan', html()->text("urutan", old("urutan"), ["class" => "form-control","placeholder" => "n", "required" => "required"]) ],
			'is_aktif' => ['Is Aktif', html()->text("is_aktif", old("is_aktif"))->class("form-control") ],
			'tgl_mulai' => ['Tgl Mulai', html()->text("tgl_mulai", old("tgl_mulai"))->class("form-control")->class("datepicker") ],
			'tgl_selesai' => ['Tgl Selesai', html()->text("tgl_selesai", old("tgl_selesai"))->class("form-control")->class("datepicker") ],
			'kode_semester' => ['Kode Semester', html()->text("kode_semester", old("kode_semester"))->class("form-control") ],
	...
	function store(Request $request)
	{
		...
		$semester->is_aktif = $request->input("is_aktif");
	...
	public function edit(Request $request, Semester $semester)
	{
		...
		$data['forms'] = array(
			'semester' => ['Semester', html()->text("semester", $semester->semester)->class("form-control") ],
			'urutan' => ['Urutan', html()->text("urutan", $semester->urutan, ["class" => "form-control","placeholder" => "n", "required" => "required", "id" => "urutan"]) ],
			'is_aktif' => ['Is Aktif', html()->text("is_aktif", $semester->is_aktif)->class("form-control") ],
			'tgl_mulai' => ['Tgl Mulai', html()->text("tgl_mulai", $semester->tgl_mulai)->class("form-control")->class("datepicker") ],
			'tgl_selesai' => ['Tgl Selesai', html()->text("tgl_selesai", $semester->tgl_selesai)->class("form-control")->class("datepicker") ],
			'kode_semester' => ['Kode Semester', html()->text("kode_semester", $semester->kode_semester)->class("form-control") ],
