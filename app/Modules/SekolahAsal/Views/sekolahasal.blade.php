                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <form action="{{ route('sekolahasal.index') }}" method="get">
                                ...
                                <div class="col-2">
                                    {!! button('sekolahasal.create', $title) !!}  
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive mb-2">
								...
								<td>Npsn</td>
									...
									<td>{{ $item->npsn }}</td>
                                                ...
                                                <td>
                                                    {!! button('sekolahasal.show','', $item->id) !!}
                                                    {!! button('sekolahasal.edit', $title, $item->id) !!}
                                                    {!! button('sekolahasal.destroy', $title, $item->id) !!}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
